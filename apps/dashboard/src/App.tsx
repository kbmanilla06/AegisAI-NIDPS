...
export function App() {
  ...
  return (
    <main>
      <header>
        <div>
          <p className="eyebrow">Sprint 5 Gate 5S-A synthetic-only evidence</p>
          <h1>AegisAI NIDPS</h1>
        </div>
          ...
          <div className="grid">
            ...
            {can("synthetic_datasets:read") && (
              <section className="panel" aria-labelledby="synthetic-title">
                ...
                <p>Fixed seed 20260714 · canonical flow v1 · 39 model features plus 7 non-model provenance columns · no model work.</p>
                <ul>
